...
coche = Coche("Amarillo", "Lamborghini", "Urus", 305, 650, 4)

coche_1 = Coche("Rojo", "Ferrari", "488 Pista", 340, 720, 2)

coche_2 = Coche("Azul", "Porsche", "911 Turbo S", 330, 650, 2)

coche_3 = Coche("Negro", "McLaren", "720S", 341, 720, 2)
